...
```bash
npm install bitcore-wallet-service-anon
cd bitcore-wallet-service-anon
```
...
```
### Configuration
Configuration for all required modules can be specified in https://github.com/anonymousbitcoin/bitcore-wallet-service-anon/blob/master/config.js
