...
describe('Wallet service', function() {
    ...
    describe('shared wallets (BIP44)', function() {
      ...
      it('should create address', function(done) {
        server.createAddress({}, function(err, address) {
          ...
          address.isChange.should.be.false;
          address.coin.should.equal('anon');
    ...
    describe('1-of-1 (BIP44 & P2PKH)', function() {
      beforeEach(function(done) {
        helpers.createAndJoinWallet(1, 1, function(s, w) {
          server = s;
          wallet = w;
          w.copayers[0].id.should.equal(TestData.copayers[0].id44anon);
          done();
        });
      });
  ...
  describe('Multiple request Pub Keys', function() {
    ...
    beforeEach(function() {
      ...
      var copayerId = Model.Copayer._xPubToCopayerId('anon', TestData.copayers[0].xPubKey_44H_0H_0H);
      opts = {
        copayerId: copayerId,
  ...
  describe('#getFeeLevels', function() {
    ...
    it('should get default fees if network cannot be accessed', function(done) {
      ...
      server.getFeeLevels({}, function(err, fees) {
        ...
        var defaults = _.zipObject(_.map(Defaults.FEE_LEVELS['anon'], function(item) {
    ...
    it('should get monotonically decreasing fee values', function(done) {
      _.find(Defaults.FEE_LEVELS['anon'], {
        nbBlocks: 6
  ...
  var addrMap = {
    anon: 't1h8SqgtM3QM5e2M8EzhhT1yL2PXXtA6oqe',
  }
  ...
  _.each(['anon'], function(coin) {
      ...
      describe('Tx proposal creation & publishing ' + coin, function() {
        ...
        describe('Fee levels', function() {
          it('should create a tx specifying feeLevel', function(done) {
            //ToDo
            var level = wallet.coin == 'anon' ? 'economy' : 'normal';
            var expected = wallet.coin == 'anon' ? 180e2 : 200e2;
            helpers.stubFeeLevels({
              1: 400e2,
              2: 200e2,
              6: 180e2,
    ...
    describe('UTXO Selection', function() {
      ...
      it('should select unconfirmed utxos if not enough confirmed utxos', function(done) {
        helpers.stubUtxos(server, wallet, ['u 1anon', '0.5anon'], function() {
          var txOpts = {
            outputs: [{
              toAddress: 't1h8SqgtM3QM5e2M8EzhhT1yL2PXXtA6oqe',
              amount: 0.8e8,
  ...
  describe('#getWalletFromIdentifier', function() {
    ...
    it('should get wallet from tx proposal', function(done) {
      helpers.stubUtxos(server, wallet, '1 anon', function() {
        helpers.stubBroadcast();
        var txOpts = {
          outputs: [{
            toAddress: 't1h8SqgtM3QM5e2M8EzhhT1yL2PXXtA6oqe',
